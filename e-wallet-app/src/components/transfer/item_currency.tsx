...
export const ItemCurrency = ({...props}) => {
  ...
  return (
    <div className={`flex justify-between items-center my-4`}>
        ...
        <div >
            {/* <h1 className={`w-full font-semibold text-xl text-end`}>{formatCurrency(data.balance,props.symbol)}</h1> */}
            <h1 className={`w-full font-semibold text-xl text-end`}>1200</h1>
  ...
  return (
    <div className={`flex animate-pulse justify-between items-center my-4`}>
        <div className={`flex items-center`}>
            ...
            <div className={`ml-2`}>
                <h1 className={`text-xl w-[200px] mb-2 rounded-full h-4 bg-gray-200`}></h1>
                <h1 className={` text-xl w-[150px] rounded-full h-4 bg-gray-200`}></h1>
            </div>
        </div>
        <div >
            <h1 className={`w-[100px] mb-2 rounded-full h-4 bg-gray-200 text-xl text-end`}></h1>
