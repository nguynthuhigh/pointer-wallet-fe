...
const SearchUser = ({...props}) => {
    ...
    return (
        ...
        <input name='search' 
         ...
         <InfoUser isLoading={isLoading} data={data} handleSelectUser={handleSelectUser} handleUserData={handleUserData}></InfoUser>
        </div>
    ...
    const InfoUser = ({...props})=>{
        return (
            <>{props.isLoading === false &&
                ...
                {props.isLoading === true && <div  class={`flex animate-pulse w-full rounded-lg items-center font-semibold p-2 cursor-pointer hover:bg-gray-100 mt-4`}>
