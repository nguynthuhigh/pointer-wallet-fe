        ...
        <div class={`p-6  max-w-[600px] mx-auto bg-white rounded-lg shadow-lg`} >
            <div class={`flex items-center`}>
                <div class={`font-semibold space-y-2`}>
                    ...
                    <h1 class={`text-6xl max-sm:text-3xl`}>{formatCurrency(data?.amount,data?.currency.symbol)}</h1>
                    <h1 class={`text-gray-400 font-`}>{formatDate(data?.createdAt ? data?.createdAt : new Date())}</h1>
                </div>
            ...
            <div class={`space-y-2`}>
                ...
                <div class={`flex`}>
                    ...
                    <h1  class={`w-[50%] font-semibold overflow-hidden whitespace-nowrap overflow-ellipsis`}>{data?.orderID}	</h1>
                </div>
                <div class={`flex`}>
            ...
            <div class={`flex `}>
                    ...
                    <h1 class={`ml-auto font-semibold`}>{formatCurrency(newAmount,data?.currency.symbol)}</h1>
                </div>
