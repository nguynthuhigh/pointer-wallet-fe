        ...
        <div class={`p-4 bg-white`}>
            ...
            <div class={`bg-white rounded-2xl`}>
                ...
                <div class={`space-y-4 text-center py-4 font-semibold`}>
                    ...
                    <h1 class={`text-sm text-gray-500`}>{formatDate(transactionData?.createdAt ?? new Date())}</h1>
                </div>
                <div class={`p-4 font-semibold`}>
                    <div class={` rounded-xl border-bg-gray border w-full p-4`}>
                        ...
                        <div class={`space-y-2 w-full mt-2 mb-0.5`}>
                            <div class={`flex`}>
                                ...
                                <h1 class={`text-sm text-black ml-auto`}>{transactionData?.message}</h1>
                            </div>
                            <div class={`flex`}>
                                <h1 class={`text-sm text-gray-400`}>Nhà cung cấp</h1>
                                <h1 class={`text-sm text-black ml-auto`}>{transactionData?.partnerID.name}</h1>
                            </div>
                        </div>
                    ...
                    <div class={`flex w-full justify-between mt-5`}>
                        ...
                        <Link class={`border p-1.5 rounded-xl w-[48%] text-center`} to='/'>Tiếp tục thanh toán</Link>
                    </div>
                </div>
            </div>
        </div>
