...
const SideBarPart = ({...props}) => {
  return (
    <Link to={props.link} onClick={props.handleSelect} className='h-[50px] my-2 w-full flex'>
        ...
        <div className={`flex h-full w-full items-center rounded-lg ml-4 px-4 hover:bg-gray-100 transition-colors duration-300 ${props.name === props.selected && 'bg-blue-600 hover:bg-blue-700'}`}>
