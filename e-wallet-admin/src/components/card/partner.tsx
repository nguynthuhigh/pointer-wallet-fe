...
import { ICardPartner } from "@/interfaces/card-partner"
                ...
                <div id="ViewPartner">
                    <div className="flex items-center justify-between h-full">
                        <div className="flex w-[350px] h-full gap-x-[10px] ">
                            <Link to={`/partner-list/detail/${id}`} className=" absolute right-[10px] cursor-pointer top-[20px] text-[#FFFFFF] border-[1px] p-2 border-[#0094FF] rounded-full bg-[#0094FF]">
                            ...
                            <div className="flex flex-col justify-center gap-y-[10px]">
                                ...
                                <div id="Email">
                                    ...
                                    <div id="Value" className="font-semibold text-md">{email ? email : 'null'}</div>
                                </div>
