    ...
    return(
        <div className={`bg-${props.color}-50 my-2 h-fit p-3 rounded-xl flex`}>
            ...
            <div className='ml-2'>
                ...
                <h1 className={`font-semibold text-sm text-${props.color}-500`}>{props.currency}</h1>
            </div>
            <h1 className={`ml-auto my-auto font-semibold text-sm text-${props.color}-500`}>{props?.percent}%</h1>
        </div>
    )
}
