...
const Icon = ({ type }) => {
  if (type === "visa") {
    return (
      <img
        alt=""
        className="w-[30px] absolute right-0 top-0 mt-3 mr-2 mx-[2px] border-[1px] border-gray-300 p-1 rounded-[5px]"
  ...
  if (type === "mastercard") {
    return (
      <img
        alt=""
        className="w-[25px] absolute right-0 top-0 mt-[10px] mr-2 mx-[2px] border-[1px] border-gray-300 p-1 rounded-[5px]"
  ...
  if (type === "jcb") {
    return (
      <img
        alt=""
        className="w-[25px] absolute right-0 top-0 mt-3 mr-2 mx-[2px] border-[1px] border-gray-300 p-1 rounded-[5px]"
...
export default function TabCard({ dataTransaction }) {
  ...
  return (
    <div className="w-[650px] bg-white h-[572px] rounded-xl">
      <section class="bg-white mx-auto rouned-xl mt-10 w-full py-8 antialiased dark:bg-gray-900 md:py-16">
        <h2 class="text-xl mx-auto w-full  font-semibold text-gray-900 dark:text-white sm:text-2xl ml-8">
          Thanh toán
        </h2>
        ...
        <form
          ...
          action="#"
          class="w-full mx-auto   my-auto rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8"
        >
          <div class="mb-6 grid mx-auto w-full grid-cols-2 gap-4">
            ...
            <div class="col-span-2 sm:col-span-1">
              <div className="flex">
                ...
                <div class="mb-2 block text-sm font-medium text-red-600 dark:text-white ml-2 ">
                  {error.number_card}
                </div>
              </div>
              <div className="relative">
                <input
                  ...
                  class={
                    !error.number_card
                      ? `block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pe-10 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500  `
                      : `block w-full rounded-lg border-[1px] border-red-500`
                  }
          ...
          {isLoading ? (
            <button
              disabled
              type="submit"
              class="flex w-full items-center justify-center rounded-lg bg-gray-300  px-5 py-2.5 text-sm font-medium text-white"
            >
              <Spin></Spin>
            </button>
          ) : (
