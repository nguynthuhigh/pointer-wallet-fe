...
export default function AddWebHook() {
    ...
    return <form onSubmit={hanldeRegister}>
        ...
        <div className='flex justify-center space-x-[20px]'>
            <button type="submit"
                className="w-[130px] text-center text-white  mt-5 bg-blue-600 font-medium rounded-lg text-sm p-3">
                Generate Key
            </button>
            {isLoading
                ? <LoadingButtonWebhook />
                : <button type="submit"
                    className="w-[130px] text-center text-white  mt-5 bg-blue-600 font-medium rounded-lg text-sm ">
                    Register
                </button>}
