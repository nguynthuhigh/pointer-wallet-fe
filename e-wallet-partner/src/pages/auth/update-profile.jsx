              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    id="name"
                    placeholder="example: pressPay Company"
                ...
                <div className="mt-0">
                  ...
                  <input
                    ...
                    name="description"
                    id="description"
                    placeholder="example: we are the best"
                    className={
                  ...
                  <div class="flex items-center justify-center w-full">
                    ...
                    <label
                      for="dropzone-file"
                      class="flex mt-2 flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                    >
