...
export default function EditVoucher() {
  ...
  return (
    <div className='flex'>
      ...
      {isLoading ? 'Loading...' :
        <form className="px-5 w-full mx-auto bg-white shadow rounded-[15px] " onSubmit={handleSubmit}>
          <HeaderDashboard title="Edit Voucher"></HeaderDashboard>
            <div className="mb-5 grid grid-cols-2 gap-x-[30px]">
            ...
            <div className="mb-5 grid grid-cols-2 gap-x-[30px]">
              ...
              <div>
                ...
                <select id="countries" onChange={(e) => handleChange('type', e.target.value)} value={data.data.type} class="border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-g0 ">
